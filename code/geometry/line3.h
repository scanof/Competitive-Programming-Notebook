...
ld ang (ln3 l1, ln3 l2) { return small_ang(l1.d, l2.d);}

bool parallel(ln3 l1, ln3 l2){ return l1.d%l2.d == zero;}
bool perp(ln3 l1, ln3 l2){ return (l1.d|l2.d) == 0;}
///PLANE - LN3
ld ang(plane p, ln3 l){ return pi/2 - small_ang(p.n, l.d);}
bool parallel(plane p, ln3 l){ return (p.n|l.d) == 0;}
bool perp(plane p, ln3 l){ return p.n%l.d == zero;}
ln3 perp_at(plane p, p3 o){ return line(o, o+p.n);}
plane perp_at(ln3 l, p3 o){ return plane(l.d, o);}
